...
/**
 * Extract the most recently invoked slash command from a Qwen Code JSONL
 * transcript file. Returns the command name (no leading slash) or null.
 *
 * Qwen Code embeds slash invocations in user messages as
...
function readLastSlashCommand(transcriptPath) {
  ...
  // Command names in Qwen Code transcripts are plain identifiers like "gsd-plan-phase"
