...
- Usage: Reference from command with `@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
