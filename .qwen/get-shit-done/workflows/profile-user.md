...
Key references:
- @/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/ui-brand.md (display patterns)
- @/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md" "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/user-profiling.md`
...
Reference: @/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global QWEN.md" -- "Add profile to /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/QWEN.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/QWEN.md"
...
```bash
BACKUP_PATH="/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/USER-PROFILE.backup.md"
```
...
Your profile:    /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/skills/gsd-dev-preferences/SKILL.md
  ✓ QWEN.md section       ./QWEN.md
  ✓ Global QWEN.md        /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/QWEN.md
```
