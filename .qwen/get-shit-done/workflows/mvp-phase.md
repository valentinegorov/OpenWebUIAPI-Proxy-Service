...
<required_reading>
@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/user-story-template.md
@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/spidr-splitting.md
@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/spidr-splitting.md`. Briefly:
