...
`./.qwen/skills/spike-findings-[project]/` (project-local) and summary to
...
- [ ] Spike-findings skill exists at `./.qwen/skills/` with SKILL.md (including requirements), references/, sources/
