...
```bash
INIT=$(node "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/templates/spec.md.
