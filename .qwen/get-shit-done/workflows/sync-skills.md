...
INSTALL_JS_GLOBAL="/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
