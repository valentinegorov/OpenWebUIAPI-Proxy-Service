...
- **Global scope**: `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/`)
...
2. Glob `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/*.md` (if directory exists) — global notes
...
Global (/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/` — works in any directory
