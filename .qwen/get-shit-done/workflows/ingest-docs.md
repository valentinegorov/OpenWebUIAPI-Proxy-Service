...
```bash
INIT=$(node "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/bin/gsd-tools.cjs" commit \
