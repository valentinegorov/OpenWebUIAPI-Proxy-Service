...
<required_reading>
@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/ai-frameworks.md
@/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-eval-planner.md for instructions.
