...
```
Agent(
  prompt="Read /home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/get-shit-done/templates/SECURITY.md`
