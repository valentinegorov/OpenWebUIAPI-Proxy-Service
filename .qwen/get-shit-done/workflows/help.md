...
- Saves timestamped note to `.planning/notes/` (or `/home/ve/work/OpenWebUIAPI-Proxy-Service/.qwen/notes/` globally)
...
- **`/gsd-ultraplan-phase [phase]`** — [BETA] Offload plan phase to Qwen Code's ultraplan cloud; review in browser and import back.
